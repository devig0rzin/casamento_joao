...
export const gifts: Gift[] = [
  ...
  },
  {
    ...
    price: 65,
    status: "available",
    image: "/presentes/jogo-de-copos.jpg",
  ...
  },
  {
    ...
    price: 180,
    status: "available",
    image: "/presentes/jogo-de-panelas.jpg",
  ...
  },
  {
    ...
    price: 240,
    status: "reserved",
    image: "/presentes/jogo-de-jantar.jpg",
  ...
  },
  {
    ...
    price: 50,
    status: "available",
    image: "/presentes/petisqueira.jpg",
    description: "Para servir petiscos nos encontros da casa nova.",
  },
  {
    id: "jogo-prato",
    name: "Jogo de prato",
    ...
    price: 80,
    status: "available",
    image: "/presentes/jogo-de-pratos.jpg",
    description: "Mesa posta para receber a familia com carinho.",
  },
  {
    id: "kit-toalha-banho",
    ...
    price: 70,
    status: "available",
    image: "/presentes/kit-toalha-de-banho.jpg",
    description: "Conforto para o dia a dia dos noivos.",
  },
  {
    id: "jogo-cortina",
    name: "Jogo de cortina",
    category: "sala",
    price: 120,
    status: "available",
    image: "/presentes/jogo-de-cortinas.jpg",
    description: "Um toque de privacidade e aconchego para a casa.",
  },
  {
    id: "jogo-capa-sofa",
    name: "Jogo de capa de sofa",
    category: "sala",
    price: 95,
    status: "available",
    image: "/presentes/jogo-de-capa-de-sofa.jpg",
    description: "Para deixar a sala mais bonita e protegida.",
  },
  {
    id: "jogo-cama",
    name: "Jogo de cama",
  ...
  },
  {
    ...
    price: 120,
    status: "available",
    image: "/presentes/sanduicheira.jpg",
    description: "Para preparar lanches rapidos na casa nova.",
  },
  {
    id: "liquidificador",
    name: "Liquidificador",
    ...
    price: 90,
    status: "available",
    image: "https://images.unsplash.com/photo-1570222094114-d054a817e56b?auto=format&fit=crop&w=900&q=82",
    description: "Praticidade para receitas e vitaminas.",
  },
  {
    id: "aspirador-po",
    ...
    description: "Ajuda para manter a casa sempre em ordem.",
  },
  {
    id: "ferro",
    name: "Ferro",
    ...
    price: 250,
    status: "available",
    image: "/presentes/ferro.jpg",
    description: "Para cuidar das roupas da vida nova.",
  },
  {
    id: "passeio-noivos",
    ...
    description: "Um momento para curtir depois do casamento.",
  },
  {
    id: "corte-cabelo-noivo",
    ...
    description: "Para o noivo chegar alinhado no grande dia.",
  },
  {
    id: "penteado-noiva",
    name: "Penteado da noiva",
    category: "experiencias",
    price: 350,
    status: "available",
    image: "/presentes/penteado-da-noiva.jpg",
    description: "Um carinho para a noiva no dia especial.",
  },
  {
    id: "almoco-noivos",
    name: "Almoco pros noivos",
    category: "experiencias",
    price: 250,
    status: "available",
    image: "/presentes/almoco-pros-noivos.jpg",
    description: "Uma refeicao especial para celebrar.",
  },
  {
    id: "fundi",
    name: "Fundi",
    ...
    price: 200,
    status: "available",
    image: "/presentes/fundi.jpg",
    description: "Um presente simbolico para os noivos aproveitarem juntos.",
  },
  {
    id: "eletrodomestico-sonho",
    name: "Eletrodomestico do sonho",
    category: "cozinha",
    price: 600,
    status: "available",
    image: "https://images.unsplash.com/photo-1556911220-bff31c812dba?auto=format&fit=crop&w=900&q=82",
    description: "Uma ajuda para realizar o item mais desejado da casa.",
  },
];
...
export const faqs = [
  ...
  ["Como funciona a lista de presentes?", "Voce adiciona um ou mais itens ao carrinho e paga o valor total por Pix."],
] as const;
